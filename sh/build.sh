...
###
 ...
 # @LastEditors  : moli-pp
 # @LastEditTime : 2025-04-11 15:13:09
...
SYNC_COMMAND="rsync -aqz --delete --exclude='.*/' --exclude='.*' /root/workspace/ /root/MHCB12/vendor/xiaomi/mijia_ble_mesh/ && find /root/MHCB12/vendor/xiaomi/mijia_ble_mesh/ -type f -exec dos2unix {} \; >/dev/null 2>&1"
